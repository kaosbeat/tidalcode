...
//     if (mode == "raw"){
//         switch (submodeint){
//             // case 1 :{ p5.rectsconfig.trigger = "note";break;}
//             // case 2 :{ p5.rectsconfig.trigger = "cc";break;}
//             // case 3 :{ p5.rectsconfig.trigger = "andrew";break;}
//             // case 4 :{ p5.rectsconfig.trigger = "clock";break;} ///beatclock note 61 on tidal channel 15            
...
//             // case 5 :{ p5.rectsconfig.trigger = "modulate";break;}
...
function initMidi(p5){
    ...
    //     if (p5.rectsconfig.trigger == "clock") {
    //         p5.rectsconfig.seed = fakeRandom(p5.rectsconfig.seed) 
    //         createRects()
    //     }
    // });
    ...
    // tidal.onNote("*", ({note, velocity, channel})=> {
    //     // console.log("hello")
    //     if (p5.rectsconfig.trigger  == "andrew") {
    //         p5.rectsconfig.seed = note
    //         createRects()
    //     }
    // })
    ...
    tidal.onCC("*", ({index, value, channel}) => {
        ...
        if (channel  == 1) {
            switch (index) {
                case 1: {
                    if (value == 1){ p5.cubesconfig.render = true; console.log("switch rendering on");} else { p5.cubesconfig.render = false;} break;
